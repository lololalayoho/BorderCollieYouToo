...
if("TRUE" STREQUAL "TRUE")
  set(stereo_msgs_SOURCE_PREFIX /home/nvidia/catkin_ws/src/common_msg/stereo_msgs)
...
if(NOT "/home/nvidia/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/catkin_ws/src/common_msg/stereo_msgs/${idir}'.  ${_report}")
    endif()
