...
if("TRUE" STREQUAL "TRUE")
  set(imu_bno055_SOURCE_PREFIX /home/nvidia/catkin_ws/src/imu_bno055)
...
if(NOT "/home/nvidia/catkin_ws/src/imu_bno055/include " STREQUAL " ")
  set(imu_bno055_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/catkin_ws/src/imu_bno055/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_bno055' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/catkin_ws/src/imu_bno055/${idir}'.  ${_report}")
    endif()
